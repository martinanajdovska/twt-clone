...
public interface TweetRepository extends JpaRepository<Tweet,Long> {
    List<Tweet> findAllByUserUsernameIsInAndParentTweetIsNull(List<String> usernames);
    ...
    List<Tweet> findAllByParentTweetOrderByCreatedAtDesc(Tweet tweet, Pageable pageable);
}
